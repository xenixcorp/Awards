package com.xenix.award.helper.skeleton;
...
import com.xenix.award.helper.skeleton.Master.SkeletonAttribute;
import com.xenix.award.helper.skeleton.Master.SkeletonMaster;
import com.xenix.award.helper.skeleton.utils.ColorUtils;
...
public class SkeletonGroup extends SkeletonMaster {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //Log.i("SkeletonGroup","onLayout " + position);
        // Add all children extend from SkeletonView
        if (skeletonAttributesChildren == null && skeletonAttribute.isShowSkeleton()) {
            //Log.i("SkeletonGroup","onLayout and skeletonAttributesChildren == null ... " + position);
...
//            Log.i("SkeletonGroup dispatchDraw " + position);
            ...
            if (paintGradient == null) {
                ...
                for (int i = 0; i < skeletonAttributesChildren.size(); i++) {
                    ...
                    if (skeletonAttributeChild.getShapeType() == SkeletonAttribute.SHAPE_TYPE_RECT) {
                        ...
                        //Log.i("SkeletonGroup", "line number  " + lineNumber);
...
//                        }
                        //Log.i("SkeletonGroup", "Alpha: " + alpha);
    ...
    private void setupInitialAnimation() {
        ...
        valueAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationRepeat(Animator animation) {
                //Log.i("SkeletonGroup","onAnimationRepeat " + position);

                if (isCanDrawFinishState) {
                    //Log.i("SkeletonGroup","isCanDrawFinishState " + position);
                ...
                if (isLastLoopAnimation) {
                    ...
                    //Log.i("SkeletonGroup","isLastLoopAnimatio " + position);
