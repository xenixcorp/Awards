package com.xenix.award.helper.skeleton.Master;
...
import com.xenix.award.helper.skeleton.utils.ConverterUnitUtil;
...
public class SkeletonMaster extends RelativeLayout {
    ...
    public void init(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            skeletonAttribute.setColorBackgroundMain(typedArray.getColor(R.styleable.Skeleton_SK_backgroundMainColor, getResources().getColor(SkeletonAttribute.DEFAULT_COLOR_BACKGROUND_MAIN)));
